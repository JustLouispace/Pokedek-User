  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        ...
        window.alert('Login failed. Please try again.'); // Display alert message
      }
    },
  });
            ...
            <MDBCard className='bg-dark text-white my-5 mx-auto' style={{ borderRadius: '1rem', maxWidth: '550px' }}>
              <MDBCardBody className='p-5 d-flex flex-column align-items-center mx-auto w-100'>
                ...
                <div className='text-center'>
                  ...
                  <p className="mb-0">
                    Have you Forgot your password account?{' '}
                    <a href="http://localhost:3000/forgot-password" className="text-white-50 fw-bold">
                      Forgot Password
                    </a>
                  </p>
                </div>
